                            ...
                            <div class="card" style="border-radius: 15px;">
                                <div class="card-body p-5">
                                    ...
                                    <form action="SignUp" method="get">
                                        ...
                                        <!--5- date of birth-->    
                                        <div class="form-outline mb-4">
                                            <label class="form-label" for="email">Your date of birth</label>
                                            <input type="date" id="dbo" name= "dbo" class="form-control form-control-lg" />
                                        ...
                                        <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="login.jsp"
                                                                                                                class="fw-bold text-body"><u>Login here</u>
                                            </a>
                                        </p>
